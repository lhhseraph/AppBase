...
public class NetStateReceiver extends BroadcastReceiver {
    ...
    public final static String CUSTOM_ANDROID_NET_CHANGE_ACTION = "com.github.obsessive.library.net.conn" + "" +
            ".CONNECTIVITY_CHANGE";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equalsIgnoreCase(ANDROID_NET_CHANGE_ACTION) || intent.getAction().equalsIgnoreCase
            ...
            if (!NetworkUtils.isAvailable(context)) {
                ...
                isNetAvailable = true;
                mNetType = NetworkUtils.getConnectedType(context);
            }
            notifyObserver();
        }
    }
