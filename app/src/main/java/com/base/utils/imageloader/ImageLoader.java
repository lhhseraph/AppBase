...
//     * drawable资源："android.resource://com.frank.glide/drawable/news"或load"android.resource://com.frank
//     * .glide/drawable/"+R.drawable.news<p/>
...
//    }
//
//    public static void loadTarget(Context context, Object objUrl, ImageLoadConfig config, final LoaderListener
//            listener) {
//        load(context, null, objUrl, config, listener);
//    }
//
//    private static void load(Context context, ImageView view, Object objUrl, ImageLoadConfig config, final
...
//                        @Override
//                        public boolean onException(Exception e, Object model, Target<Bitmap> target, boolean
//                                isFirstResource) {
//                            if (null != listener) {
//                                listener.onError();
//                            }
...
//
//                        @Override
//                        public boolean onResourceReady(Bitmap resource, Object model, Target<Bitmap> target, boolean
...
//        return SimpleGlideModule.cache != null && uri != null ? SimpleGlideModule.cache.get(new StringSignature(uri))
//                : null;
//    }
//}
