...
public class EasyPermissions {
    ...
    public interface PermissionCallbacks extends ActivityCompat.OnRequestPermissionsResultCallback {
        void showRequestPermissionRationale(int requestCode, List<String> perms);
    ...
    public static void requestPermissions(final Object object, String rationale, @StringRes int positiveButton,
        ...
        KLog.e("perms.length = " + perms.length);
        List<String> deniedPermissions = findDeniedPermissions(object, perms);
        KLog.e("deniedPermissions.size = " + deniedPermissions.size());
        final String[] permissions = new String[deniedPermissions.size()];
        deniedPermissions.toArray(permissions);
        KLog.e("permissions.length = " + permissions.length);
        ...
        if (shouldShowRationale) {
            ...
            ((PermissionCallbacks) object).showRequestPermissionRationale(requestCode, Arrays.asList(permissions));
//
...
//                            executePermissionsRequest(object, permissions, requestCode);
//                        }
//                    })
...
//                                ((PermissionCallbacks) object).onPermissionsDenied(requestCode, Arrays.asList
// (permissions));
//                            }
//                        }
//                    }).create();
//            dialog.show();
    ...
    public static List<String> findDeniedPermissions(final Object object, String... permission) {
        Context context = null;
        String[] perms;
        if (object instanceof Activity) {
            context = ((Activity) object).getApplication();
        ...
        for (String value : permission) {
            if (!hasPermissions(context, value)) {
     ...
     */
    public static void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults, Object
            object) {
     ...
     */
    public static boolean checkDeniedPermissionsNeverAskAgain(final Object object, String rationale, @StringRes int
            positiveButton, @StringRes int negativeButton, List<String> deniedPerms) {
     ...
     */
    public static boolean checkDeniedPermissionsNeverAskAgain(final Object object, String rationale, @StringRes int
            positiveButton, @StringRes int negativeButton, @Nullable DialogInterface.OnClickListener
            negativeButtonOnClickListener, List<String> deniedPerms) {
        ...
        for (String perm : deniedPerms) {
            ...
            if (shouldShowRationale) {
                ...
                AlertDialog dialog = new AlertDialog.Builder(activity).setMessage(rationale).setPositiveButton
