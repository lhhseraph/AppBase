...
public class PackageUtils {
    ...
    public static boolean checkPermission(String permName) {
        return checkPermission(permName, BaseUtils.getAppContext().getPackageName());
    }
    ...
    public static void goToInstalledAppDetails(Context context, String packageName) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.GINGERBREAD) {
            ...
            intent.putExtra((sdkVersion == Build.VERSION_CODES.FROYO ? "pkg" : "com.android.settings" + "" +
                    ".ApplicationPkgName"), packageName);
        }
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        context.startActivity(intent);
    }
