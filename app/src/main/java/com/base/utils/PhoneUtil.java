...
public final class PhoneUtil {
     ...
     */
    public static void openCamera(int requestcode, Activity activity, String fileName) {
     ...
     * @param activity    上下文
     */
    public static void openPhotoAlbum(int requestcode, Activity activity) {
    ...
    public static Cursor getContactsNameAndNumber(Context context) {
        return context.getContentResolver().query(ContactsContract.CommonDataKinds.Phone.CONTENT_URI, new
                String[]{ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME, ContactsContract.CommonDataKinds.Phone
                .NUMBER}, null, null, ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME + " COLLATE LOCALIZED ASC");
    }
    ...
    public static List<HashMap<String, String>> getAllContactInfo(Context context) {
        ...
        while (cursor.moveToNext()) {
            ...
            if (!StringUtils.isEmpty(contact_id)) {//null   ""
                ...
                Cursor c = resolver.query(date_uri, new String[]{"data1", "mimetype"}, "raw_contact_id=?", new
