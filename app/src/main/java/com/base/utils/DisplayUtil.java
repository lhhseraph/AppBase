...
public class DisplayUtil {
    ...
    public static int getScreenWidth() {
        return BaseUtils.getAppContext().getResources().getDisplayMetrics().widthPixels;
    }
    ...
    public static int getScreenHeight() {
        return BaseUtils.getAppContext().getResources().getDisplayMetrics().heightPixels;
    }
    ...
    public static float dpToPx(float dp) {
        return dp * BaseUtils.getAppContext().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToDp(float px) {
        return px / BaseUtils.getAppContext().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToSp(float pxValue) {
        return pxValue / BaseUtils.getAppContext().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    public static float spToPx(float spValue) {
        return spValue * BaseUtils.getAppContext().getResources().getDisplayMetrics().scaledDensity;
    }
}
