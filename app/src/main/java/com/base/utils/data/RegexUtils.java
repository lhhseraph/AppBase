...
public class RegexUtils {
     ...
     * 匹配全网IP的正则表达式
     */
    public static final String IP_REGEX = "^((?:(?:25[0-5]|2[0-4]\\d|((1\\d{2})|([1-9]?\\d)))\\.){3}" + "" +
     ...
     * 匹配身份证号的正则表达式
     */
    public static final String ID_CARD = "^(^[1-9]\\d{7}((0\\d)|(1[0-2]))(([0|1|2]\\d)|3[0-1])\\d{3}$)|" + "" +
     ...
     * // 判断一个字符串是否都为十六进制字符
     */
    public static boolean checkHex(String aNumber, int len) {
