...
import com.base.netstatus.NetworkService;
...
public class NetworkUtils {
    ...
    public enum NetType {
        None(1, "无网络连接"), Mobile(2, "蜂窝移动网络"), Wifi(4, "Wifi网络"), Other(8, "未知网络");
    ...
    public enum NetWorkType {
        UnKnown(-1, "未知网络"), Wifi(1, "Wifi网络"), Net2G(2, "2G网络"), Net3G(3, "3G网络"), Net4G(4, "4G网络");
    ...
    public static final boolean isGpsEnabled() {
        LocationManager locationManager = (LocationManager) BaseUtils.getAppContext().getSystemService(Context
                .LOCATION_SERVICE);
    ...
    public static final void openGPS() {
        ...
        try {
            PendingIntent.getBroadcast(BaseUtils.getAppContext(), 0, GPSIntent, 0).send();
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent != null) {
                ...
                switch (CURRENT_NETWORK_STATE) {
                    case -1:
                        KLog.d("网络更改为 无网络  CURRENT_NETWORK_STATE =" + CURRENT_NETWORK_STATE);
                        break;
                    case 1:
                        KLog.d("网络更改为 WIFI网络  CURRENT_NETWORK_STATE=" + CURRENT_NETWORK_STATE);
                        break;
                    case 2:
                        KLog.d("网络更改为 移动网络  CURRENT_NETWORK_STATE =" + CURRENT_NETWORK_STATE);
                        break;
